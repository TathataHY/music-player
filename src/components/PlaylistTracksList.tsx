...
const ListHeaderComponent = ({ playlist, search }: { playlist: Playlist; search: string }) => {
  return (
    <View>
      ...
      {search.length === 0 && <QueueControls style={{ paddingTop: 24 }} tracks={playlist.tracks} />}
    </View>
  )
}
...
export const PlaylistTracksList = ({ playlist }: { playlist: Playlist }) => {
  ...
  return (
    <TracksList
      ...
      ListHeaderComponent={() => <ListHeaderComponent playlist={playlist} search={search} />}
